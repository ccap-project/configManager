...
type GetProviderHandlerFunc func(GetProviderParams, *models.Customer) middleware.Responder

// Handle executing the request and returning a response
func (fn GetProviderHandlerFunc) Handle(params GetProviderParams, principal *models.Customer) middleware.Responder {
	return fn(params, principal)
}

// GetProviderHandler interface for that can handle valid get provider params
type GetProviderHandler interface {
	Handle(GetProviderParams, *models.Customer) middleware.Responder
}
...
/*GetProvider swagger:route GET /cell/{cell_id}/provider provider getProvider

Find provider

Returns cell's provider
