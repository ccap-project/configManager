...
type DeleteProviderHandlerFunc func(DeleteProviderParams, *models.Customer) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteProviderHandlerFunc) Handle(params DeleteProviderParams, principal *models.Customer) middleware.Responder {
...
type DeleteProviderHandler interface {
	Handle(DeleteProviderParams, *models.Customer) middleware.Responder
}
...
/*DeleteProvider swagger:route DELETE /provider/{cell_id}/provider/{provider_id} provider deleteProvider
