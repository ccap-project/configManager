...
func (o *FindCellComponentsOK) WithPayload(payload []*models.Component) *FindCellComponentsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the find cell components o k response
func (o *FindCellComponentsOK) SetPayload(payload []*models.Component) {
	o.Payload = payload
}
...
func (o *FindCellComponentsOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	payload := o.Payload
	if payload == nil {
		payload = make([]*models.Component, 0, 50)
	}
